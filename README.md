...
2. Create scatter plots of important relationships among species, waterbodies, and health metrics of interest.  
3. View your raw data (i.e., if you are a contributing member)
4. Search source material within the repository
6. View a map of all the studies, species, and data types in the repository
7. Search species within the repository
8. Upload your data (i.e., if you are a contributing member)
9. View documentation
10. Register as a contributing member
...
This repository contains a shiny app built as a package (i.e, [{glatar}](https://benjaminhlina.github.io/glatar-app/)) along with Dockerfiles, `{renv}` files, a shell file, nginx and shiny-server configuration files, and a html file. 
